...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',default="configs/cascade_mask_rcnn_x101_64x4d_fpn_1x.py")
    parser.add_argument('--checkpoint', help='checkpoint file',default="tools/epoch_41.pth")
    parser.add_argument(
        '--out', type=str, help='output ONNX filename', default='seoulchallenge.onnx')
    parser.add_argument(
        '--shape',
        type=int,
        nargs='+',
    ...
    parser.add_argument(
        '--passes', type=str, nargs='+', help='ONNX optimization passes',default=None)

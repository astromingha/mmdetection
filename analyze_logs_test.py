...
def add_plot_parser(subparsers):
    ...
    parser_plt.add_argument(
        '--json_logs',
        default='logs/20200226_205545.log.json',
        type=str,
        nargs='+',
...
def parse_args():
    ...
    # subparsers = parser.add_subparsers(dest="'plot_curve'", help='task parser')
...
def main():
    parser = argparse.ArgumentParser(description='plot_curve')
